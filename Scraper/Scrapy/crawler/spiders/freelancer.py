...
class FreelancerSpider(scrapy.Spider):
    ...
    def parse_job(self, response):
        ...
        il.add_css('title','h1.PageProjectViewLogout-projectInfo-title::text')
        il.add_css('description','div.PageProjectViewLogout-detail::text')
        il.add_css('price','div.ProjectViewDetails-budget::text')
        il.add_css('location','span[itemprop="addressLocality"]::text')
        il.add_css('skills','div.Content::text')
